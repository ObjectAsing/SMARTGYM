...
<body class="app header-fixed-hidden sidebar-fixed-hidden aside-menu-fixed-hidden aside-menu-hidden">
<!--  <header class="app-header-hidden navbar-hidden">
    ...
    <ul class="nav navbar-nav ml-auto">
      <li class="nav-item d-md-down-none">
        <a class="nav-link" href="#">
            <i class="icon-location-pin-hidden"></i>
