            ...
            <div class="row clear_fix">
                <div class="col-md-4 col-md-offset-4 login-form"  style="position: relative">
                    ...
                    <form id="frm_login" role="form" action="<?php echo base_url() ?>auth/login" method="POST">
                      ...
                      <br>
                    <a href="<?php echo base_url()?>forgetPass" class="btn btn-danger btn-block center">Forget password</a>
                    <br>

					 <!-- <div class="btn btn-primary btn-block center">-- >
						<!--	<div class="center"> -->
								<a href="<?php echo base_url() ?>" class="btn btn-primary btn-block center" >BACK HOMEPAGE</a>
							</div>
...
<div class="container-fluid navbar-fixed-bottom text-center text-info">Software designed by &nbsp;&nbsp;<a style="font-size: 12px;" href="http://ftmk.utem.edu.my/web/" target="_blank">FTMK DEVELOPER</div>
        <script>
